...
/**
 * This example shows how to delete classes.
 * @author Daniele Canavese
 **/
public class DeletesClasses extends Sample
{
	/**
	 * Launch the sample.
	 * @throws Exception
	...
	public void run() throws Exception
	{
		...
		// Print all the classes in the ontology.
		for (OntologyClass i : ontology.getThing().getSubClasses(false))
		...
		// Print all the classes in the ontology again.
		for (OntologyClass i : ontology.getThing().getSubClasses(false))
			System.out.println(i);
