...
/**
 * This example shows how to serialize an ontology.
 * @author Daniele Canavese
 **/
public class SerializesOntologies extends Sample
{
	/**
	 * Launch the sample.
	 * @throws Exception
	...
	public void run() throws Exception
	{
		...
		// Serialize the ontology as a string..
		System.out.println(ontology.serialize());
