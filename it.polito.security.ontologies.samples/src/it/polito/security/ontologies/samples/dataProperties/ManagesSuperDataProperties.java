 ...
 **/
public class ManagesSuperDataProperties extends Sample
{
	...
	public void run() throws Exception
	{
		...
		property1.addSuperProperty("hasboolean");
		ontology.flush();

		// Retrieve the named direct super-property of a property.
		for (OntologyDataProperty i : property1.getSuperProperties(true))
			System.out.println(i);
		System.out.println();

		// Retrieve the named indirect super-property of a property.
		for (OntologyDataProperty i : property1.getSuperProperties(false))
			System.out.println(i);
